...
<head>
    ...
    <title>Dashboard-SwiftCredit</title>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="/admin" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">SwiftCredit</span>
                    </a>
                ...
                <div class="mb-2">
                    {{-- <div class="d-flex justify-content-center align-items-center">
                        <img src="dashboards/assets/img/avatars/1.png" alt class=" h-auto rounded-circle" />
                    </div> --}}
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item ">
                        <a href="{{ url('/show_user') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-home-circle"></i>
                            <div data-i18n="Analytics">Show User</div>
                        </a>
                    </li>
                    {{-- <li class="menu-item">
                                ...
                                <div class="nav-item d-flex align-items-center">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="#">
                                            ...
                                            <span class="align-middle">Your Loan has arrived</span>
                                        </a>
                                        <a class="dropdown-item" href="#">
                                            <i class="bx bx-notification me-2"></i>
                                ...
                                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                        ...
                                        <div class="avatar avatar-online">
                                            <img src="dashboards/assets/img/avatars/1.png" alt
                            ...
                            <div class="row">
                                <div class="container mt-4 bg-white p-4 rounded shadow">
                                    <div class="d-flex justify-content-between mb-3">
                                      <h4>All Applicants  Details</h4>
                                      <a href="{{ url('/personal') }}" class="btn btn-primary">
                               ...
                               @foreach ($personal as $personals)
                                        <tr>
                                          <td>{{ $personals->id }}</td>
                                          {{-- <td>20230715</td> --}}
                                          <td>{{ $personals->name }} {{ $personals->lastname  }}</td>
                                          {{-- <td>20</td> --}}
                                          <td>{{ $personals->phone }}</td>
                                          <td>{{ $personals->email }}</td>
                                          <td>{{ $personals->payment_status }}</td>
                                        <td>
                                            @if($personals->payment_status == "processing....")

                                            <a onclick="return confirm('Are you sure that you want to approve this loan')" class="btn btn-primary" href="{{ url('delivered', $personals->id) }}">Approve</a>
