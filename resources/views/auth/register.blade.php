...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-dashboards/assets-path="dashboards/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="dashboards/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">SwiftCredit</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Adventure starts here 🚀</h4>
                        <p class="mb-3 color-primary">Make your app management easy and fun!</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="form-control" id="firstname"
                                    placeholder="Enter your firstname" autofocus :value="old('name')" required autofocus autocomplete="name" />
                            </div>
                            <div class="mb-3">
                                <label for="lastname" class="form-label">Last Name</label>
                                <input type="text" name="lastname" class="form-control" id="lastname" name="lastname"
                                    placeholder="Enter your lastname" autofocus :value="old('lastname')" required autofocus autocomplete="name"  />
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control"
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password" name="password_confirmation" required autocomplete="new-password" />
                                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h5 class="card-title text-primary">Welcome To SwiftCredit, John! 🌟</h5>
                                <p class="mb-4">
                                    It's great to see you again, John! Your financial journey with us starts. Explore
                                    your account and take advantage of our services to achieve your goals.
                                </p>

                                <a href="/" class="btn btn-sm btn-outline-primary">View Account</a>
                            </div>
                        </div>

                        <div class="col-sm-5 text-center text-sm-left">
                            <div class="card-body pb-0 px-0 px-md-4">
                                <img src="dashboards/assets/img/illustrations/man-with-laptop-light.png"
