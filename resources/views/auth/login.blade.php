...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="dashboards/assets/"
...
<head>
    ...
    <link rel="stylesheet" href="dashboards/assets/vendor/css/theme-default.css" class="template-customizer-theme-css" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to SwiftCredit! 👋</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email"
                                    placeholder="Enter your Email" autofocus :value="old('email')" required autofocus autocomplete="username" />
                            </div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" data-bs-toggle="modal"
                                    data-bs-target="#modalCenter">Sign in</button>
                            </div>
                        </form>
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    It's great to see you again, John! Your financial journey with us continues. Explore
